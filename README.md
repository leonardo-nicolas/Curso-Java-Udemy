# Aprendizados do curso de [Java](https://www.udemy.com/course/fundamentos-de-programacao-com-java/) pela plataforma [Udemy](https://www.udemy.com/)
...
<table cellpadding="0" cellspacing="0">
    <thead>
        <tr>
            <th colspan="2">Os módulos de ☕Java☕ em si...</th>
        </tr>
        <tr>
            <th>Fundamentos</th>
    ...
    <tbody style="vertical-align:middle">
        ...
        <tr>
            <td rowspan="10"> <strong>Paradigmas</strong>
                <ul>
                    <li>✅ Imperativo</li>
                    <li>✅ Funcional</li>
        ...
        <tr>
            <td rowspan="7"> <strong>Pilares</strong>
                <ul>
